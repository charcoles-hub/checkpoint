...
const STRINGS = {
  es: {
    ...
    'feeling.toggle': '✦ Por feeling',
    'feeling.cancel': '✕ Normal',
    'feeling.submit': 'Buscar coincidencias →',
    'feeling.placeholder': 'Ej: algo como Zelda pero más oscuro y difícil...',
    'feeling.loading': 'Buscando coincidencias...',
    'feeling.results': '{n} coincidencias para "{q}"',
    'feeling.no_results': 'No encontramos coincidencias. Prueba con otra descripción.',
    'feeling.error': 'No se pudo procesar la descripción, inténtalo de nuevo.',
    'feeling.too_short': 'Escribe al menos 10 caracteres.',
  ...
  en: {
    ...
    'feeling.toggle': '✦ By feeling',
    'feeling.cancel': '✕ Normal',
    'feeling.submit': 'Find matches →',
    'feeling.placeholder': 'E.g. something like Zelda but darker and harder...',
    'feeling.loading': 'Finding matches...',
    'feeling.results': '{n} matches for "{q}"',
    'feeling.no_results': 'No matches found. Try a different description.',
    'feeling.error': 'Could not process the description, please try again.',
    'feeling.too_short': 'Write at least 10 characters.',
